...
public class TemperatureConverter {
    ...
    private double temperatureTranslate(int temperatureUnit, int temperatureSecondUnit, double temperatureNumber){
        double result =0;
        ...
        if(temperatureUnit == 5 && temperatureSecondUnit == 4){
            result = (temperatureNumber * 2.25) + 32 + 459.67;
        }
        // From Réaumur to Celsius
        if(temperatureUnit == 5 && temperatureSecondUnit == 2){
            result = temperatureNumber * 1.25;
        }
        return result;
    }
